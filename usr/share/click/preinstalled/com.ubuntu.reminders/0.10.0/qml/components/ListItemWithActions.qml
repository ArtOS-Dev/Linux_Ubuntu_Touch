...
Item {
    ...
    property color color: Suru.backgroundColor
    property color selectedRightActionColor: Suru.highlightColor
           ...
           Repeater {
               ...
               Item {
                   ...
                   Icon {
                       ...
                       color: root.activeAction === modelData || !root.triggerActionOnMouseRelease ? root.selectedRightActionColor : Suru.secondaryForegroundColor
                       Suru.highlightType: Suru.NegativeHighlight
                   }
                   Rectangle {
                       id: underscore
