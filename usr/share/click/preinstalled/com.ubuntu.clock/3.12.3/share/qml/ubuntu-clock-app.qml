    ...
    */
    ...
    MainView {
        ...
        Settings {
            ...
            property string defaultAlarmSound:""
            property int    alarmListSortOrder: Qt.AscendingOrder
        }
        ...
        PageStack {
            ...
            MainPage {
                ...
                /*
               FIXME: When the upstream QT bug at https://bugreports.qt.io/browse/QTBUG-40275 is fixed
