...
Page {
    ...
    ScrollView {
        ...
        Column {
            ...
            CenteredLabel {
                text: "<a href='https://gitlab.com/ubports/app-dev/ubports-app'>" + i18n.tr("SOURCE") + "</a> | <a href='https://gitlab.com/ubports/app-dev/ubports-app/issues'>" + i18n.tr("ISSUES") + "</a> | <a href='https://liberapay.com/ubports'>" + i18n.tr("DONATE") + "</a>"
            }
            ...
            UbuntuShape {
                ...
                source: Image {
                    source: Qt.resolvedUrl("../assets/legal.svg")
                    sourceSize.width: parent.width
                    sourceSize.height: parent.height
                }
            }
            ...
            CenteredLabel {
                text: "<b>" + i18n.tr("Copyright (c) 2018 UBports <ubports.com>") + "</b>"
            }
