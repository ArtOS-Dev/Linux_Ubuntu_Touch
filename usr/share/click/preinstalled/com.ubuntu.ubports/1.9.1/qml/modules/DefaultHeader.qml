...
PageHeader {
    ...
    trailingActionBar {
        ...
        Action {
            ...
            text: "Blog"
            onTriggered: Qt.openUrlExternally("https://ubports.com/blog/ubports-blog-1/tag/blogs-2")
        }, Action {
            ...
            onTriggered: Qt.openUrlExternally("https://ubports.com/community/get-involved")
        }, Action {
            iconName: "dekko-app-symbolic"
            text: i18n.tr("Newsletter")
            onTriggered: Qt.openUrlExternally("https://list.ubports.com/mailman/listinfo")
        }, Action {
